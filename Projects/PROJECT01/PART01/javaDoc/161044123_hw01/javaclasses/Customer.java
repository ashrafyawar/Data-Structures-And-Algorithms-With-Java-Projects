...
class Customer extends User{
	...
	*/
	Customer(String name,String surename ,String position, int password){super(name,surename,position,password);}
	...
	*/
	Package getPackageReffrence(){return packageClassReffrence;}
	/**
	...
	*/
	void setPackageReffrence(Package packageClassReffrence){this.packageClassReffrence = packageClassReffrence;}
}