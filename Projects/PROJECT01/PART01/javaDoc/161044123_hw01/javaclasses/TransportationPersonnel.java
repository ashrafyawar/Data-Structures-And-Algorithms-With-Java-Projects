...
*/
class TransportationPersonnel extends User{
	...
	*/
	TransportationPersonnel(String name,String surename ,String position, int password){super(name,surename,position,password);}
}