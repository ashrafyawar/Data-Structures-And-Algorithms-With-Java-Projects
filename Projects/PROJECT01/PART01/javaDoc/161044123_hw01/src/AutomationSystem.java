	...
	public static void main(String[] args) {
		...
		while(isAdminAdded == false){
			...
			if(command.equals("1")){
				...
				adminObject.setPassword(Integer.parseInt(inputstream.nextLine()));
		...
		while(flag == true){
			...
			if(selection.equals("1")){
				...
				int password = Integer.parseInt(inputstream.nextLine());
					...
					if (isAdminExist == true){
						...
						while(correctCommand == true){ // if the user info is correct in the list then login
							...
							if(command.equals("1")){
								...
								branchObject.setName(inputstream.nextLine());
								...
								int removalbranchIndex = Integer.parseInt(inputstream.nextLine());
								...
								System.out.print(" password:");
								branchEmployeeObject.setPassword( Integer.parseInt(inputstream.nextLine()));
								...
								int branchIndex = Integer.parseInt(inputstream.nextLine());
								...
								System.out.print(" password:");
								transportationPersonnelObject.setPassword( Integer.parseInt(inputstream.nextLine()));
					...
					if(isBranchEmployeeExist == true){
						...
						while(correctCommand == true){
							...
							if(command.equals("1")){
								...
								customerObject.setPassword(Integer.parseInt(inputstream.nextLine()));
								...
								if (choise.equals("1")){
									...
									int customer_branchIndex = Integer.parseInt(inputstream.nextLine());
									...
									packageObject.setPackageName(inputstream.nextLine());
									packageObject.setPackageStatus("inbranch");
									System.out.print("Package Tracking packageTrackingNumber: ");
									packageObject.setpackageTrackingNumber(Integer.parseInt(inputstream.nextLine()));
								...
								int packageTrackingNumber = Integer.parseInt(inputstream.nextLine());
